...
[ Gz1 ] = SimplifiedAlgorithm ( u, y, 1, 1, 0,  T, [Plot 1 2] )
%% 2 st order estimation
[ Gz2 ] = SimplifiedAlgorithm ( u, y, 2, 1, 1, T, [Plot 3 4] )
%% 3 st order estimation
[ Gz3 ] = SimplifiedAlgorithm ( u, y, 3, 1, 1, T, [Plot 5 6] )
